...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xb055b;
...
const char     CRYPTONOTE_NAME[]                             = "dripcoin";
...
const int      P2P_DEFAULT_PORT                              = 65302;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 65303;
